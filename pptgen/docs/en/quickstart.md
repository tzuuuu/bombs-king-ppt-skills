...
- `template/`: When a master template is supplied, its copied `.ppt/.pptx`, `template.pdf`, rendered `template-<N>.png` pages, and manifest
- `generated_images/`: All intermediate candidates generated by slide sub-agents, including rejected variants
