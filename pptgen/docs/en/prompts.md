...
```text
Please use the pptgen skill to turn this material into a 15-slide presentation. Use architecture.png on slide 4 and benchmark-results.png on slide 9.
```
