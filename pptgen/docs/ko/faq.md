...
아닙니다. Codex PPT는 각 페이지가 하나의 완성된 이미지인 Slide Image Set을 생성합니다. 시각 효과는 일관되지만 텍스트와 도형을 개별적으로 편집할 수는 없습니다. 재현 가능한 Data Chart 소스 패키지는 후속 재구성을 위해 별도로 전달됩니다. 레이아웃이나 시각 효과를 조정하려면 같은 대화에서 AI에게 특정 페이지를 수정하도록 요청하세요.
